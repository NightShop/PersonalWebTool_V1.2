...
namespace PersonalWebTool_V1.Migrations
{
    ...
    [Migration("20210107094550_AddedGratefulnessModel")]
    partial class AddedGratefulnessModel
    {
            ...
            modelBuilder.Entity("PersonalWebTool_V1.Models.BlogPost", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreated = new DateTime(2021, 1, 7, 10, 45, 49, 477, DateTimeKind.Local).AddTicks(6947),
                            ImageName = "open-sign",
                            PostCategoryID = 4,
                        ...
                        new
                        {
                            ...
                            DateCreated = new DateTime(2021, 1, 7, 10, 45, 49, 480, DateTimeKind.Local).AddTicks(8903),
            ...
            modelBuilder.Entity("PersonalWebTool_V1.Models.GratefulnessEntry", b =>
                {
                    ...
                    b.ToTable("GratefulnessEntry");

                    b.HasData(
                        new
                        {
                            GratefulnessEntryID = 1,
                            DateCreated = new DateTime(2021, 1, 7, 10, 45, 49, 497, DateTimeKind.Local).AddTicks(563)
                        });
                });
