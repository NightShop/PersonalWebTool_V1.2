...
namespace PersonalWebTool_V1.Migrations
{
    ...
    [Migration("20210105132221_AddedGratefulnessSector")]
    partial class AddedGratefulnessSector
    {
            ...
            modelBuilder.Entity("PersonalWebTool_V1.Models.BlogPost", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreated = new DateTime(2021, 1, 5, 14, 22, 20, 834, DateTimeKind.Local).AddTicks(6523),
                            ImageName = "open-sign",
                            PostCategoryID = 4,
                        ...
                        new
                        {
                            ...
                            DateCreated = new DateTime(2021, 1, 5, 14, 22, 20, 838, DateTimeKind.Local).AddTicks(1839),
